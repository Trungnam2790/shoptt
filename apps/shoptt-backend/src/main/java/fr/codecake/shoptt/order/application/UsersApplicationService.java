package fr.codecake.shoptt.order.application;
...
import fr.codecake.shoptt.order.domain.user.service.UserReader;
import fr.codecake.shoptt.order.domain.user.service.UserSynchronizer;
...
import fr.codecake.shoptt.order.infrastructure.secondary.service.kinde.KindeService;
import fr.codecake.shoptt.shared.authentication.application.AuthenticatedUser;
